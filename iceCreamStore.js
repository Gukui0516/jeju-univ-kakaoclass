...
//실습2
//가장 많이 팔린 아이템 찾기
let bestSoldIceCream = Object.keys(flavorDistribution).reduce((currBest, newBest) => {
    if(flavorDistribution[currBest] > flavorDistribution[newBest]){
        return currBest;
    } else {
        return newBest;
    }
...
console.log(`가장 많이 팔린 아이스크림: ${bestSoldIceCream}`);